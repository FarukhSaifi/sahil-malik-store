        ...
        <Container>
          ...
          <div className="mx-auto grid max-w-4xl gap-12 lg:grid-cols-2">
            <div className="space-y-6 text-sm sm:text-base">
              {contact.address ? (
                <div>
                  <h3 className="mb-2 uppercase tracking-[0.2em] text-xs text-muted">
                    {SITE.contact.headings.atelier}
                  </h3>
                  <p className="font-display text-lg font-light sm:text-xl">{contact.storeTitle}</p>
